...
public class DocumentTest extends TestCase {
    ...
    public void testSelect() throws Exception {
        ...
        assertTrue(Utility.select(new Point(1,1), 8,document).size() == 1);
        assertTrue(Utility.select(new Point(1,1), 8,document).firstElement().getID() == c.getID());
    }
    ...
    public void testSelect2() throws Exception {
        ...
        assertTrue(Utility.select(new Point(1,1), 8, document).size()==2);
    }
